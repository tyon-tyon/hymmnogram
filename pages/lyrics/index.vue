...
useHead({
  ...
  meta: [
    ...
    { property: 'og:url', content: 'https://hymmnogram.fau-varda.net/lyrics/' + (selectedTag.value ? `?tag=${selectedTag.value}` : '') },
  ],
  link: [
    { rel: 'canonical', href: 'https://hymmnogram.fau-varda.net/lyrics/' + (selectedTag.value ? `?tag=${selectedTag.value}` : '') },
  ],
});
