...
const words_json_1 = __importDefault(require("../in/words.json"));
const idioms_json_1 = __importDefault(require("../in/idioms.json"));
    ...
    const getPartialMatch = (query) => {
        ...
        return words.value.filter(w => {
            ...
            return w.hymmnos.toLowerCase().includes(lowerCaseQuery) ||
                ...
                ((_b = w.pronunciation) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes(lowerCaseQuery)) ||
