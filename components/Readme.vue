<template>
  <section class="mb-10">
    ...
    <AtomH3>
      ダークモードだとかなり閲覧しづらいサイトとなっています。ブラウザのカラーモードをライトに変更してください。
    </AtomH3>
    <AtomH3>
  ...
  <section class="mb-10">
    ...
    <ul class="list-disc list-inside mb-4">
      ...
      <li>
        <strong>一括意味表示</strong>:
        入力されたヒュムノス文から、使用されている単語の意味を一括で表示します。
      </li>
      <li>
        <strong>用例検索</strong>:
  ...
  <section class="mb-10">
    ...
    <ul class="list-disc list-inside mb-4">
      ...
      <li>
        <strong>一括意味表示</strong>:
        カーソルがある行の文章の意味をリアルタイムで表示します。ヒュムノス語、律史前月読、アルシエラの
        3 つの言語に対応しています。
      </li>
      <li>
        <strong>入力支援</strong>:
